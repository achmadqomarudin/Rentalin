...
public class UpdateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Spinner spTypeEngineeCar;
    ...
    private void setViewData() {
        etNameCar.setText(getIntent().getStringExtra("name_car"));
        etSeats.setText(getIntent().getStringExtra("type_seat"));
        etPriceDay.setText(getIntent().getStringExtra("price"));
        tvNotification.setText(getIntent().getStringExtra("attachment"));
        setSpinTextTypeEnginee(spTypeEngineeCar, getIntent().getStringExtra("type_enginee"));
    }

    //untuk get text dari menu AdminActivity
    public void setSpinTextTypeEnginee(Spinner spin, String text) {
    ...
    private void addDataImage() {
        if (ContextCompat.checkSelfPermission(UpdateActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED){
            ...
            ActivityCompat.requestPermissions(UpdateActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 9);
        }
    }
    ...
    private void postData() {
        ...
        String sp_code_car = getIntent().getStringExtra("car_code");
        ...
        if (!TextUtils.isEmpty(name_car) && !TextUtils.isEmpty(price_day) && !TextUtils.isEmpty(attachment)
            ...
            collectionReference.document(sp_code_car).collection("data").document(id).update(userMap)
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        storageReference.child("Uploads").child(fileName).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                final String code_car = getIntent().getStringExtra("car_code");
