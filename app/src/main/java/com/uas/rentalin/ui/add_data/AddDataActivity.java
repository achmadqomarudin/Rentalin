package com.uas.rentalin.ui.add_data;
...
public class AddDataActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void addDataImage() {
        if (ContextCompat.checkSelfPermission(AddDataActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED){
            selectImage();
        } else {
            ActivityCompat.requestPermissions(AddDataActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 9);
        }
    }
